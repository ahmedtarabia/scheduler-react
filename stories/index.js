...
// DayListItem component related code
...
// DayList component related code
const days = [
  {
    id: 1,
    name: "Monday",
...
//InterviewerListItem component related code.
...
//InterviewerList component related code.
const interviewers = [
...
//Appointment Components related code.
storiesOf("Appointment", module)
  ...
  .add("Create", () => (
    <Form 
      interviewers={interviewers} 
      onSave={(student, interviewer) => action("onSave")(student, interviewer)} 
      onCancel={action("onCancel")} 
    />
  ))
  .add("Edit", () => (
    <Form 
      student="Ahmed Tarabia" 
      interviewer={2}
      interviewers={interviewers} 
      onSave={(student, interviewer) => action("onSave")(student, interviewer)} 
      onCancel={action("onCancel")} 
